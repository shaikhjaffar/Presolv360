...
import Image1 from '../assets/Images/Impact_1.gif'
...
export default function Outcome() {
    ...
    function showDataAccordian1(id) {
        ...
        if (question.classList.contains("active_acc1")) {
            ...
            console.log(question.getAttribute('data'))
        } else {
    ...
    useEffect(() => {
        inView(document.getElementById('about_mobile_child_2'), () => {
            showDataAccordian1('about_mobile_child_1')
        })
                ...
                <div className='accordian_section_wrap'>
                    <div className="faq_main_container">
                        <div className="faq_container">
                            <div className="faq_question1" id='about_mobile_child_1' data="0" onClick={() => { showDataAccordian1('about_mobile_child_1') }}>
                        ...
                        <div className="faq_container">
                            <div className="faq_question1" id='about_mobile_child_2' data="1" onClick={() => { showDataAccordian1('about_mobile_child_2') }}>
                                <div className="faq_question-text">
                                    <h3>Economical</h3>
                                </div>
                                <div className="icon">
                        ...
                        <div className="faq_container">
                            <div className="faq_question1" id='about_mobile_child_3' data="2" onClick={() => { showDataAccordian1('about_mobile_child_3') }}>
                                <div className="faq_question-text">
                                    <h3>Social</h3>
                                </div>
                                <div className="icon">
